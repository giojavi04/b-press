 ...
 * Register Menus
 */
require_once(get_template_directory().'/functions/register-menus.php');

/**
 * Register Widgets
 */
require_once(get_template_directory().'/functions/register-widgets.php');
...
if ( shift_is_plugin_active('contact-form-7/wp-contact-form-7.php') ) {
  require_once(get_template_directory().'/functions/save-contact-form.php');
}
